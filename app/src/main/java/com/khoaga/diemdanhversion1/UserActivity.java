...
public class UserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        un=extras.getString("TENDANGNHAP","N/A");//lấy giá trị của cái key là USERNAME
        pw=extras.getString("MATKHAU","N/A");// như trên
        hoten=extras.getString("TENNGUOIDUNG","N/A");// vẫn rứa
           ...
           oPw= edtOldPw.getText().toString();
            ...
            if(oPw.trim().equals("")||nPw.trim().equals("")||rnPw.trim().equals("")){
                ...
                try {
                    ...
                    if (conn != null) {
                        int resultSet;
                        String query = "Update NGUOIDUNG set matkhau='" + rnPw  + "' where  matkhau='" + pw + "' and tendangnhap='"+un+"'";
