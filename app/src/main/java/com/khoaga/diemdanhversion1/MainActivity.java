        ...
        protected String doInBackground(String... params) {
            try {
                ...
                if (con == null) {
                    ...
                    //String query = "select * from NGUOIDUNG where TENDANGNHAP='" + userid + "' and MATKHAU='" + HASH.md5(password) + "'";
                    String query = "select * from NGUOIDUNG where TENDANGNHAP='" + userid + "' and MATKHAU='" + password + "'";
